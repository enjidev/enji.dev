...
```html {footer:false} {inlineHighlight:data-accent|1|violet} {inlineHighlight:text-accent-600|2,3|violet} {inlineHighlight:data-accent|2|blue} {inlineHighlight:text-accent-600|4|blue}
<!-- default to :root -->
