...
I've been using CRA for a few years now, but since discovering Next.js, I don't think I would want to use any other web framework. **It's just that good!**

---

## UI/UX Designer

Designing user interfaces is something I'm really good at and I've been a UI/UX designer **since 2017 ({new Date().getFullYear() - 2017} years)**.
