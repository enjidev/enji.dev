...
Want to see something cool? Click this button and watch the accent colors on this page **change from violet to blue** or vice versa.

<AccentDemo />

And BOOM! the button doesn't change the colors of all components. This single line of code;

```js
document.documentElement.setAttribute('data-accent', newAccent);
```

does the magic by simply changing the html `data-accent` attribute value to the new accent color.
