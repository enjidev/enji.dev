...
export function VSCodeIcon({ ...props }: ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <title>Visual Studio Code 图标</title>
