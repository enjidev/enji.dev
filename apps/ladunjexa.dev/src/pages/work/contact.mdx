...
| Contact | Detail                    |
| ------- | ------------------------- |
| Address | Southern District, Israel |
| E-mail  | business@ladunjexa.dev    |
...
If you want to find me on social media, just search for **@ladunjexa** / **@lironabutbul**. That's my username on almost all platforms, so it should be easy to find me.

But if you're short on time, I've included some links to the social media platforms I use most frequently below.

| Social Media | Profile URL                            |
| ------------ | -------------------------------------- |
| LinkedIn     | https://linkedin.com/in/lironabutbul   |
| Instagram    | https://www.instagram.com/lironabutbul |
| Telegram     | https://t.me/ladunjexa                 |
